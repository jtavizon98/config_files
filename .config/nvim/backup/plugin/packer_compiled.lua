...
_G.packer_plugins = {
  ...
  ["bclose.vim"] = {
    loaded = true,
    path = "$HOME/.local/share/nvim/site/pack/packer/start/bclose.vim",
  ...
  cmp_luasnip = {
    loaded = true,
    path = "$HOME/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
    url = "https://github.com/saadparwaiz1/cmp_luasnip"
  },
  indentLine = {
    loaded = true,
    path = "$HOME/.local/share/nvim/site/pack/packer/start/indentLine",
  ...
  orgmode = {
    ...
    loaded = true,
    path = "$HOME/.local/share/nvim/site/pack/packer/start/orgmode",
  ...
  ["ranger.vim"] = {
    loaded = true,
    path = "$HOME/.local/share/nvim/site/pack/packer/start/ranger.vim",
