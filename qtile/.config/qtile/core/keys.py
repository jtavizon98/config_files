...
def _wyspr_toggle(qtile, output):
    ...
    command = [
        os.path.join(script_path, "wyspr"),
        "record",
        "toggle",
        "--output",
        output,
...
_wayland_keys = [
    ...
    Key(
        ...
        desc="Toggle voice recording to clipboard",
    ),
    Key(
        [mod, "shift"],
        "v",
        lazy.function(_wyspr_toggle, output="type"),
        desc="Toggle voice recording with direct typing",
    ),
    # Take screenshot
    Key(
        [],
